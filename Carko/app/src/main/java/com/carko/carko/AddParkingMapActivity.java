...
public class AddParkingMapActivity extends AppCompatActivity
        implements OnMapReadyCallback {

    private static final String TAG = "AddParkingMapActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currPos!=null) {
                    Log.d(TAG, "onClick: " + currPos.toString());
                    launchParkingDetailActivity(ParkingTabActivity.FragmentToLaunch.EDIT);
                }
                finish();
            }
        });
    ...
    private void launchParkingDetailActivity(ParkingTabActivity.FragmentToLaunch ftl){
        Intent showDetails = new Intent(getApplicationContext(), ParkingDetailActivity.class);
        Bundle data = new Bundle();
        data.putParcelable("pos", currPos);
        showDetails.putExtra("bundle", data);
        showDetails.putExtra(ParkingTabActivity.FRAGMENT_TO_LAUNCH_EXTRA, ftl);
